...
for MODULE in $MODULES; do
    ...
    $REPO_HOME/$SCRIPT $YAML_HOME/$MODULE.yaml > $DOC_HOME/$MODULE.md
    #$REPO_HOME/$SCRIPT $YAML_HOME/$MODULE.yaml >$HOME/repos/dcnm-docpoc/docs/modules/$MODULE.md
done
